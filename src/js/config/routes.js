...
export default {
    ...
    'login': {
        title: '',
        url: '/pages/RoadPricing-POS/index.js'
    },
    'home': {
        title: '',
        url: '/pages/RoadPricing-POS/home/index.js'
    },
    'tab': {
        title: '',
        url: '/pages/RoadPricing-POS/tab/index.js'
    },
    'identify': {
        title: '',
        url: '/pages/RoadPricing-POS/identify/index.js'
    },
    'putIn': {
        title: '',
        url: '/pages/RoadPricing-POS/putIn/index.js'
    },
    'putInFinish': {
        title: '',
        url: '/pages/RoadPricing-POS/putInFinish/index.js'
    },
    'putOut': {
        title: '',
        url: '/pages/RoadPricing-POS/putOut/index.js'
    },
    'putOutFinish': {
        title: '',
        url: '/pages/RoadPricing-POS/putOutFinish/index.js'
    },
    'setPW': {
        title: '',
        url: '/pages/RoadPricing-POS/setPW/index.js'
    },
    'payType': {
        title: '',
        url: '/pages/RoadPricing-POS/payType/index.js'
    },
    'scan': {
        title: '',
        url: '/pages/RoadPricing-POS/scan/index.js'
    },
    'arrearageHistory': {
        title: '',
        url: '/pages/RoadPricing-POS/arrearageHistory/index.js'
    },
    'arrearageList': {
        title: '',
        url: '/pages/RoadPricing-POS/arrearageList/index.js'
    },
    'arrearageDetail': {
        title: '',
        url: '/pages/RoadPricing-POS/arrearageDetail/index.js'
    },
    //demo====================
    'demo': {

...
//		} else if (screen_height*0.5625==screen_width||screen_width * 0.5625 == screen_height){ // 判断是否属于16比9的分辨率并分别配置布局参数
//			layoutParams = new LayoutParams(screen_height - 60,
//			(int) (screen_height * 0.5625));
//
//		}
		if (bitmap.getHeight() * 0.75 == bitmap.getWidth()
				|| bitmap.getWidth() * 0.75 == bitmap.getHeight()) {// 判断是否属于4比3
			layoutParams = new LayoutParams(screen_height - 60,
					(int) (screen_height * 0.75));
		} else if (bitmap.getHeight()*0.5625==bitmap.getWidth()||bitmap.getWidth() * 0.5625 == bitmap.getHeight()){ // 判断是否属于16比9
			layoutParams = new LayoutParams(screen_height - 60,
					(int) (screen_height * 0.5625));
			...
			if(bitmap.getHeight()>=bitmap.getWidth()){
				layoutParams = new LayoutParams(screen_height - 60,
						(int) ((screen_height-60) * ((float)bitmap.getWidth()/(float)bitmap.getHeight())));
			}else{
				layoutParams = new LayoutParams(screen_height - 60,
						(int) ((screen_height-60) * ((float)bitmap.getHeight()/(float)bitmap.getWidth())));
			}
